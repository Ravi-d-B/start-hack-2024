...
def main():
    ...
    for test in tests:
        ...
        for test_competency in test_competencies:
            st.write('Test_competency_id', test_competency.id, 'Test id:', test_competency.test_id, "Competency type id:", test_competency.competency_type_id, "Questions:", test_competency.questions)
