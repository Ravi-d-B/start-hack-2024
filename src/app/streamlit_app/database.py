...
def seed_database():
    ...
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 2, 4.0, "Excellent work on Math Test 1")')
    ...
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 5, 3.5, "Good, but watch out for tricky questions")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 1, 4.0, "Very good performance overall")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 2, 2.0, "Needs to focus more on the basics")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 3, 3.5, "Good job on History Test 3")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 4, 4.0, "Excellent work on Math Test 4")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 5, 1.0, "Needs improvement in Science")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 6, 4.5, "Outstanding performance on History Test 4")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 7, 2.5, "Average understanding in Math Test 5")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 8, 2.0, "Satisfactory but could improve")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 9, 3.0, "Decent effort, but needs more practice")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 10, 4.5, "Great understanding of the concepts")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 11, 1.5, "Struggled with advanced topics in Science")')
    ...
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 13, 4.0, "Very good performance overall")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 14, 2.0, "Needs to focus more on the basics")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 15, 3.5, "Good job on Math Test 3")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 16, 4.0, "Excellent work on Science Test 3")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 17, 1.0, "Needs improvement in History")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 18, 4.5, "Outstanding performance on Math Test 4")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 9, 3.0, "Good")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 10, 3.5, "You are doing good, great!")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 11, 4.0, "Excellent work!")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 12, 1.0, "Needs improvement")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 13, 2.5, "Average understanding")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (1, 14, 2.0, "Satisfactory but could improve")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 15, 3.0, "Decent effort, but needs more practice")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (3, 16, 4.5, "Great understanding of the concepts")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 17, 1.5, "Struggled with advanced topics")')
    conn.execute('INSERT INTO student_test_evaluations (student_id, test_competency_id, score, comments) VALUES (2, 18, 4.0, "Good, but watch out for tricky questions")')
